            ...
            <h1>About Me</h1>
                <div className='blurb'>
                    <p> My name is Taylor Williamson and I am a recent Computer Science and 
                        ...
                        software engineering position in the Houston area.
                    Throughout my collegiate career, I have gained a plethora of experience 
                        ...
                        utilizing the MERN (MongoDB, Express, React, Node.js) stack, SQL, and JavaScript/TypeScript.
                    I am constantly learning and gathering new knowledge as I am striving to become a more efficient,
                        effective, and well-rounded developer. </p>
                </div>
        </section>
    )
}
